...
<div id="modalConfirmar" class="modal-flotante">
    <div class="modal-contenido" style="width: 400px; text-align: center; padding: 30px;">
        ...
        <p id="textoConfirmacion" style="color: #7f8c8d; font-size: 16px; margin-bottom: 30px;"></p>
        <div style="display: flex; justify-content: center; gap: 15px;">
            ...
            <a id="linkConfirmarAction" href="#" class="btn-eliminar"
                style="width: 120px; text-decoration: none; line-height: 40px; color: white; background: #e74c3c; border-radius: 6px; font-weight: bold;">Inactivar</a>
        </div>
    </div>
</div>

<script>
// Manejo Modal Crear/Editar
...
// Manejo Modal Confirmación (Inactivar)
